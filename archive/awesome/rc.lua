...
local cycle_prev   = true -- cycle trough all previous client or just the first
...
beautiful.init(string.format("%s/.config/awesome/powerarrow-dark/theme.lua", os.getenv("HOME")))
-- }}}
